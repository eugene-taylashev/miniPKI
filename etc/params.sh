...
DIR_KEY=$DIR_BASE/private       #-- directory for private keys
...
FTST=$DIR_KEY/test.txt	#-- a special file to verify permission
...
CA_SUBJ="$SUBJ_PREFIX/CN=rootCA"    #-- default subject line for Certificate Authority
